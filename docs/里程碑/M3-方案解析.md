...
> **关联**: [M3-实施方案](./M3-实施方案.md)(怎么做:接口/调用链/文件清单)、[00-开发规划](../总纲/00-开发规划.md) M3 章节、[M2-方案解析 §4.3](./M2-方案解析.md)(孤儿配对坑的事实依据)
>
...
- [00-开发规划](../总纲/00-开发规划.md) M3 章节与认知盲区 P0-3(截断)/P1-1(项目记忆)
- [借鉴Vercel-AI-SDK对比报告](../调研/借鉴Vercel-AI-SDK对比报告.md) §四⑥⑦(providerOptions/声明式工具)、§四④(retry)
...
**关联文档**: `./M3-实施方案.md`(怎么做)、`../总纲/00-开发规划.md`、`./M2-方案解析.md`、`../调研/借鉴Vercel-AI-SDK对比报告.md`
