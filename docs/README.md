...
| 后续 M5 实施方案 | [详设/2026-08-14_后续-M5实施方案_待审核.md](./详设/2026-08-14_后续-M5实施方案_待审核.md) | 上下文压缩（手动 /compact 优先 + aider 递归算法 + 400 误重试修复）；经三角色审阅拆分，Skill→M6、MCP→M7 后置；M5-D1~D8 拍板 |
