...
| 流式 markdown + OSC8（渐进固化形态） | M8 方案 v1 §4（已砍，M8-D12）+ 2026-08-15 走读 | 灰字流式+turn 末闪变的体验差距成实际抱怨 | **内容单元水位线顺位固化进 Static**（文本块闭合/tool_result 到达即固化，动态区只剩未完块+3 行折叠；claude-code `shouldRenderStatically` 同构）+ 可选 transcript 全屏模式（ctrl+o 式）+ OSC8 链接 |
