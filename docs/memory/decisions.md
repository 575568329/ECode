...
**日期**：2026-08-03
**状态**：✅ 已决策（用户拍板）
**影响范围**：M3 上下文管理（token 计数 → 压缩阈值判断）；同步修订 `00-开发规划.md` / `M1-技术选型与理由.md` / `M3-实施方案.md` / `M3-方案解析.md` / `里程碑功能流程图.md`
...
- 实施细节：[M3-实施方案.md](../M3-实施方案.md) 决策 1 / [M3-方案解析.md](../M3-方案解析.md) §2.2
...
- 实施细节：[M3-实施方案.md](../M3-实施方案.md) §6.1 / §6.5 / §6.9（已同步修订）
