...
| 后续 M5 实施方案 | [详设/2026-08-14_后续-M5实施方案_待审核.md](./详设/2026-08-14_后续-M5实施方案_待审核.md) | 上下文压缩 v9：**Context/History 投影分离**（抄 opencode，buildContextMessages 投影，restore 不触发压缩）+ **三级压缩** + **contextWindow models.dev 远程库** + **token usage 锚定**；基于四家源码调研；Skill/MCP→M6 |
